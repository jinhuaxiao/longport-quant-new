...
class SignalGenerator:
    ...
    def __init__(self, use_builtin_watchlist=False, max_iterations=None, account_id: str | None = None):
        ...
        self.hk_watchlist = {
            ...
            "9988.HK": {"name": "阿里巴巴-SW", "sector": "科技"},
            "9888.HK": {"name": "百度集团-SW", "sector": "科技"},
            "3690.HK": {"name": "美团-W", "sector": "科技"},
            "1810.HK": {"name": "小米集团-W", "sector": "科技"},
            "9618.HK": {"name": "京东集团-SW", "sector": "科技"},
            "1024.HK": {"name": "快手", "sector": "科技"},
            "0992.HK": {"name": "联想集团", "sector": "科技"},
            "3888.HK": {"name": "金山软件", "sector": "科技"},
            "8111.HK": {"name": "超凡网络-R", "sector": "科技"},
            "2382.HK": {"name": "舜宇光学科技", "sector": "科技"},
            "8011.HK": {"name": "中国数码信息-R", "sector": "科技"},
            "0669.HK": {"name": "创科实业", "sector": "科技"},
            "2423.HK": {"name": "贝壳-W", "sector": "科技"},
            ...
            # === 汽车 & 新能源（11个）===
            "1211.HK": {"name": "比亚迪股份", "sector": "汽车"},
            "0175.HK": {"name": "吉利汽车", "sector": "汽车"},
            "8175.HK": {"name": "吉利汽车-R", "sector": "汽车"},
            "6945.HK": {"name": "理想汽车-W", "sector": "汽车"},
            "9868.HK": {"name": "小鹏汽车-W", "sector": "汽车"},
            "2333.HK": {"name": "长城汽车", "sector": "汽车"},
            "3750.HK": {"name": "宁德时代", "sector": "新能源"},
            "0968.HK": {"name": "信义光能", "sector": "新能源"},
            "2378.HK": {"name": "保利协鑫能源", "sector": "新能源"},
            "6613.HK": {"name": "协鑫科技", "sector": "新能源"},
            "2688.HK": {"name": "新奥能源", "sector": "能源"},
            ...
            "1288.HK": {"name": "农业银行", "sector": "银行"},
            "2888.HK": {"name": "渣打集团", "sector": "银行"},
            "0011.HK": {"name": "恒生银行", "sector": "银行"},

            # === 保险（5个）===
            "2318.HK": {"name": "中国平安", "sector": "保险"},
            "1299.HK": {"name": "友邦保险", "sector": "保险"},
            "2628.HK": {"name": "中国人寿", "sector": "保险"},
            "2601.HK": {"name": "中国太保", "sector": "保险"},
            "1336.HK": {"name": "新华保险", "sector": "保险"},

            # === 能源（5个）===
            "0883.HK": {"name": "中国海洋石油", "sector": "能源"},
            "1088.HK": {"name": "中国神华", "sector": "能源"},
            "8269.HK": {"name": "泰坦能源科技", "sector": "能源"},
            "0857.HK": {"name": "中国石油", "sector": "能源"},
            "0003.HK": {"name": "香港中华煤气", "sector": "能源"},

            # === 金融（5个）===
            "0388.HK": {"name": "香港交易所", "sector": "金融"},
            "0267.HK": {"name": "中信股份", "sector": "金融"},
            "6030.HK": {"name": "中信证券", "sector": "金融"},
            "1776.HK": {"name": "广发证券", "sector": "金融"},
            "6881.HK": {"name": "中国银河", "sector": "金融"},

            # === 消费（8个）===
            "9992.HK": {"name": "泡泡玛特", "sector": "消费"},
            "1929.HK": {"name": "周大福", "sector": "消费"},
            "2020.HK": {"name": "安踏体育", "sector": "消费"},
            "1610.HK": {"name": "中粮家佳康", "sector": "消费"},
            "0027.HK": {"name": "银河娱乐", "sector": "消费"},
            "3288.HK": {"name": "永利澳门", "sector": "消费"},
            "0220.HK": {"name": "统一企业中国", "sector": "消费"},
            "0499.HK": {"name": "青岛啤酒股份", "sector": "消费"},

            # === 医药医疗（5个）===
            "1177.HK": {"name": "中国生物制药", "sector": "医药"},
            "1093.HK": {"name": "石药集团", "sector": "医药"},
            "0241.HK": {"name": "阿里健康", "sector": "医疗"},
            "1698.HK": {"name": "康希诺生物-B", "sector": "医药"},
            "3692.HK": {"name": "翰森制药", "sector": "医药"},

            # === 制造（3个）===
            "3990.HK": {"name": "美的集团-SW", "sector": "制造"},
            "6690.HK": {"name": "海尔智家", "sector": "制造"},
            "3606.HK": {"name": "福耀玻璃", "sector": "制造"},

            # === 工业物流（6个）===
            "3759.HK": {"name": "中集安瑞科", "sector": "工业"},
            "0558.HK": {"name": "力劲科技", "sector": "工业"},
            "3896.HK": {"name": "中国中车", "sector": "工业"},
            "1919.HK": {"name": "中远海控", "sector": "物流"},
            "0606.HK": {"name": "中国粮油控股", "sector": "消费"},
            "1378.HK": {"name": "中国宏桥", "sector": "工业"},

            # === ETF（2个）===
            "2800.HK": {"name": "盈富基金", "sector": "ETF"},
            "2828.HK": {"name": "恒生中国企业指数ETF", "sector": "ETF"},

            # === 通信（2个）===
            "0941.HK": {"name": "中国移动", "sector": "通信"},
            "0762.HK": {"name": "中国联通", "sector": "通信"},

            # === 其他（5个）===
            "3993.HK": {"name": "洛阳钼业", "sector": "资源"},
            "1787.HK": {"name": "山东黄金", "sector": "资源"},
            "0016.HK": {"name": "新鸿基地产", "sector": "地产"},
            "0012.HK": {"name": "恒基地产", "sector": "地产"},
